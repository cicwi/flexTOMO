...
#%% Read data and map it on disk

path = '/ufs/ciacc/flexbox/al_test/90KV_no_filt/'

dark = io.read_stack(path, 'di00')
flat = io.read_stack(path, 'io00')    
proj = io.read_stack(path, 'scan_', dtype = 'float32', memmap = '/export/scratch3/kostenko/scratch/scr_0')
...
project.SIRT(proj, vol, geom, iterations = 5)
